package net.therap.spring.interceptor;

import net.therap.spring.helper.UserHelper;
...
import static net.therap.spring.constant.Constants.EMPLOYEE;
import static net.therap.spring.constant.Constants.IS_LOGGED_IN;
import static net.therap.spring.constant.URLConstants.LOGOUT_URL;
